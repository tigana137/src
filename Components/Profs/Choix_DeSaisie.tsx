        ...
        <>
            <div className=" absolute top-0 w-full h-screen flex flex-col justify-center items-center bg-transparent">
                ...
                <div className='flex  fixed bottom-0 my-5 ml-5 mr-4 px-1'>
                    ...
                    <button type="button" className="text-white bg-green-700 hover:bg-green-800 font-medium rounded-lg text-sm px-5 py-2.5 mr-3  " onClick={() => FinalSave()}>تسجيل التغييرات</button>
                    <button className='text-white bg-red-500 hover:bg-red-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3' onClick={() => verify(false)}>إعادة الإعدادات</button>
