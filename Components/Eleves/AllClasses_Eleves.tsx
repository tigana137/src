        ...
        <>
            <div className="absolute top-0 w-full h-screen bg-white ">
                ...
                <div className='fixed bottom-0 rounded-md my-5 ml-5 mr-4 px-1'>
                    <button className='text-white bg-blue-300 cursor-not-allowed font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3' onClick={() => FinalSave(2)}>التسجيل النهائي</button>
                    <button type="button" className="text-white bg-green-700 hover:bg-green-800 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 " onClick={() => FinalSave(1)}>تسجيل التغييرات</button>
                    <button className='text-white bg-red-500 hover:bg-red-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3' onClick={() => FinalSave(-1)}>إعادة الإعدادات</button>
